describe('enterNewClientOrder_ShopEmployee', () => {
    ...
    it('a client should be able to add an order from Saturday at 9:00 to Sunday at 23:00', () => {
        ...
        cy.findByText('Orders can be purchased only from Saturday at 9:00 to Sunday at 22:59').should('not.exist')
    ...
    it('a client should not be able to add an order from Sunday at 23:00 to Saturday at 9:00', () => {
        ...
        //Set the date
        cy.get('.d-flex > .btn').click()
        cy.findByText('Orders can be purchased only from Saturday at 9:00 to Sunday at 22:59').should('exist')
    ...
    it('a shopEmployee should not be able to add a new order of a client (by entering not registered user) ', () => {
        ...
        cy.findByLabelText('Client mail').type("carletto@gmail.com", { force: true })
        //Aggiungo due banane
    ...
    it('a shopEmployee should not be able to add a new order of a client (by entering no products) ', () => {
        ...
        cy.get('#setHour').click().type("09:30")
        //Set the date
        cy.get('.d-flex > .btn').click()//Insert the user mail
    ...
    it('a shopEmployee should not be able to add a new order of a client (by entering n. of product not available) ', () => {
        //Change date for managing updating(from Saturday at 9:00 to Sunday at 23:00)
        cy.findByRole('button', { name: /set/i }).click()
        //Next month
        cy.get('.react-calendar__navigation__next-button').click()
    ...
    it('a shopEmployee should not be able to add a new order of a client (by entering negative n. of product) ', () => {
        //Change date for managing updating(from Saturday at 9:00 to Sunday at 23:00)
        cy.findByRole('button', { name: /set/i }).click()
        //Next month
        cy.get('.react-calendar__navigation__next-button').click()
    ...
    it('a shopEmployee should not be able to add a new order of a client (by entering 0 as n. of product) ', () => {
        //Change date for managing updating(from Saturday at 9:00 to Sunday at 23:00)
        cy.findByRole('button', { name: /set/i }).click()
        //Next month
        cy.get('.react-calendar__navigation__next-button').click()
    ...
    /*
        ...
        it('a shopEmployee should be able to view the rigth value of wallet ', () => {
    ...
    it('a client should be able to use a filter', () => {
        ...
        //Remove the filter
        cy.get(':nth-child(4) > .im-button').click({ force: true })

        //FARMER FILTER
        //Click filter button
        cy.get(':nth-child(4) > .below').click({ force: true })
    ...
    it('a shopEmployee should be able to view the rigth amount of available product after a purchase', () => {
        //Change date for managing updating(from Saturday at 9:00 to Sunday at 23:00)
        cy.findByRole('button', { name: /set/i }).click()
        //Next month
        cy.get('.react-calendar__navigation__next-button').click()
    ...
    it("a shopEmployee should be able to view the rigth amount of available product after a farmer's update", () => {
        //Change date for managing updating(from Saturday at 9:00 to Sunday at 23:00)
        cy.findByRole('button', { name: /set/i }).click()
        //Next month
        cy.get('.react-calendar__navigation__next-button').click()
